...
mkdir build
cd build
cmake -G "Unix Makefiles" -DLLVM_EXPERIMENTAL_TARGETS_TO_BUILD=WebAssembly -DLLVM_TARGETS_TO_BUILD=all -DCMAKE_INSTALL_PREFIX=/usr/local/llvm/ -DCMAKE_BUILD_TYPE=Release ../llvm/
make -j 
